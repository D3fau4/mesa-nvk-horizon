...
static void mt_sc_destroy(mt_ctx *c, mt_sc *sc)
{
    ...
    * and a use-after-free in a release build. This case now checks
    * after every section and stops, and skips the surface and device teardown
...
static void mt_section_a(mt_ctx *c, bool force_copy, const char *what)
{
    ...
    * original value is restored once, at the end of the case. */
...
static void mt_section_c(mt_ctx *c, bool force_copy, const char *what)
{
    ...
    * prose - see the end of this case. */
   mt_pipe pipe;
