...
# Removes what this Makefile produces, and only that. Two things under
# $(BUILD) are not ours and must survive:
#
...
clean:
	rm -rf $(filter-out $(MESA_BUILD) $(MESA_BUILD).crossid \
	                    $(BUILD)/toolchain, $(wildcard $(BUILD)/*))
